            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    _buildFoodOption("Honey", "Sweet and energizing", Icons.water_drop, Colors.amber, 0.25, 0.15),
                    const SizedBox(height: 12),
                    _buildFoodOption("Fish", "Protein-rich meal", Icons.set_meal, Colors.blue, 0.20, 0.10),
                    const SizedBox(height: 12),
                    _buildFoodOption("Berries", "Fresh and healthy", Icons.spa, Colors.purple, 0.15, 0.20),
                    const SizedBox(height: 20),
                  ],
                ),
              ),
    ...
    return Stack(
      children: [
        Scaffold(
          ...
          // -------------------------------------------------------------
          // PERUBAHAN UTAMA: Structure Body diganti menjadi Column
          // -------------------------------------------------------------
          body: Column(
            children: [
              // Bagian Scrollable (Mengisi sisa ruang di atas tombol)
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 30), // Extra space agar tidak tertutup
                    ],
                  ),
                ),
              ),

              // Bagian Fixed Button (Di luar ScrollView)
              Container(
                width: double.infinity,
                padding: const EdgeInsets.all(20),
                decoration: BoxDecoration(
